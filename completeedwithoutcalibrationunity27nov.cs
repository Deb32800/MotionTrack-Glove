...
{
    public string esp32WebSocketUrl = "ws://192.168.120.200:81"; // Replace with your ESP32 IP and WebSocket port
        ...
        if (serialOutputs[0] == "Left")
        {
            switch (serialOutputs[1])
            {
                ...
                case "Thumb":
                    ...
                    break;
                case "RotateX":
                    RotateHand(left_hand, val - left_hand_rot[0], 0, 0);
                    left_hand_rot[0] = val;
                    break;
                case "RotateY":
                    RotateHand(left_hand, 0, val / 700, 0);
                    left_hand_rot[1] = val / 700;
                    break;
                case "RotateZ":
                    RotateHand(left_hand, 0, 0, -1 * val / 400);
                    left_hand_rot[2] = -1 * val / 400;
                    break;
                case "TranslateX":
                    TranslateHand(left_hand, val / 3000, 0, 0);
                    break;
                case "TranslateY":
                    TranslateHand(left_hand, 0, val - left_hand_trans[1], 0);
                    left_hand_trans[1] = val;
                    break;
                case "TranslateZ":
                    TranslateHand(left_hand, 0, 0, val - left_hand_trans[2]);
